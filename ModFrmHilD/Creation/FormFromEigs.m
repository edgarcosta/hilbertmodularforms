...
intrinsic FormFromEigenvalues(
  ...
  for nn in Ideals(M) do
    ...
    coeffs_by_nu[nu] := IdlCoeffToEltCoeff(a_nn, nu, k, coeff_ring);
  end for;

  return cModFrmHilDEltcomp(Mk, bb, coeffs_by_nu : coeff_ring := coeff_ring);
end intrinsic;
