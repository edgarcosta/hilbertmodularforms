...
intrinsic Relations(Gens::Assoc, Relations::Assoc, MaxWeight::RngIntElt) -> Any
	{Finds all Generators and Relations}

	Mi := Parent(Gens[2][1]); // Temporarily hardcoded
	M := Parent(Mi); N := Level(Mi); n := Degree(BaseField(M));
